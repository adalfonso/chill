...
export const CastPlayer = () => {
  ...
  useEffect(() => {
    if (!playerStore.is_casting.value) {
      return;
    }
    ...
    const monitorTrackChange = (
      ...
      const np = playerStore.now_playing.value;
    ...
    playerStore.playlist.value.length,
  ...
  useEffect(() => {
    ...
    const onSessionChanged = async (
      ...
      const pl = playerStore.playlist.value;
      const idx = playerStore.index.value;
      ...
      switch (event.sessionState) {
        ...
        case cast.framework.SessionState.SESSION_STARTED: {
          ...
          playerStore.pause();
          playerStore.setPlayerIsCasting(true);
        ...
        case cast.framework.SessionState.SESSION_ENDED:
          playerStore.setPlayerIsCasting(false);
          seek(progress.value);
          break;
